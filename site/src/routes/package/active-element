    ...
    <>
      ...
      <_components.ul>
        ...
        <_components.li>
          <_components.a href="#makeActiveElementListener">
            <_components.code
              data-code-primitive-name="makeActiveElementListener"
        ...
        <_components.li>
          <_components.a href="#makeFocusListener">
            <_components.code
              data-code-primitive-name="makeFocusListener"
              data-code-package-name="active-element"
            >
              {"makeFocusListener"}
            </_components.code>
      ...
      <_components.ul>
        ...
        <_components.li>
          <_components.a href="#focus">
            <_components.code
              data-code-primitive-name="focus"
              data-code-package-name="active-element"
            >
              {"focus"}
            </_components.code>
      ...
      <_components.pre>
        <_components.code className="hljs language-ts">
          ...
          <_components.span className="hljs-title function_">{"setActiveElement"}</_components.span>
          {"(el));\r\n\r\n"}
      ...
      <_components.h2 id="focus">
        ...
        <_components.code data-code-primitive-name="focus" data-code-package-name="active-element">
          {"focus"}
        </_components.code>
      </_components.h2>
      {"\n"}
...
export default function Index() {
  return (
    <PrimitivePageMain
      ...
      name="active-element"
      stage={3}
      packageList={[{ name: "active-element", gzipped: "667 B", minified: "1.53 kB" }]}
      primitiveList={[
        { name: "createActiveElement", gzipped: "433 B", minified: "867 B" },
        { name: "createFocusSignal", gzipped: "485 B", minified: "922 B" },
        { name: "focus", gzipped: "350 B", minified: "676 B" },
        { name: "makeActiveElementListener", gzipped: "349 B", minified: "671 B" },
        { name: "makeFocusListener", gzipped: "318 B", minified: "600 B" },
      ]}
    >
      <MDXContent />
    </PrimitivePageMain>
