    ...
    <>
      <NoHydration>
        ...
        <_components.ul>
          {"\n"}
          <_components.li>
            <_components.a href="#createElementCursor">
              <_components.code
                data-code-primitive-name="createElementCursor"
                data-code-package-name="cursor"
              >
                {"createElementCursor"}
              </_components.code>
            </_components.a>
          ...
          {"\n"}
          <_components.li>
            <_components.a href="#createBodyCursor">
              <_components.code
                data-code-primitive-name="createBodyCursor"
                data-code-package-name="cursor"
              >
                {"createBodyCursor"}
              </_components.code>
      ...
      <CopyPackages packageName="@solid-primitives/cursor" />
      <NoHydration>
        {"\n"}
        <_components.h2 id="createelementcursor">
          <_components.a className="header-anchor" href="#createelementcursor">
            {"#"}
          </_components.a>
          <_components.code
            data-code-primitive-name="createElementCursor"
        ...
        <_components.ul>
          ...
          {"\n"}
          <_components.li>
            <_components.code>{"cursor"}</_components.code>
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            {"("}
            <_components.span className="hljs-string">{'"#element"'}</_components.span>
            {");\n"}
            <_components.span className="hljs-keyword">{"const"}</_components.span>
            {" [cursor, setCursor] = "}
            <_components.span className="hljs-title function_">{"createSignal"}</_components.span>
            {"("}
            <_components.span className="hljs-string">{'"pointer"'}</_components.span>
            {");\n"}
            <_components.span className="hljs-keyword">{"const"}</_components.span>
            {" [enabled, setEnabled] = "}
            <_components.span className="hljs-title function_">{"createSignal"}</_components.span>
            ...
            <_components.span className="hljs-title function_">{"enabled"}</_components.span>
            {"() && target, cursor);\n\n"}
            <_components.span className="hljs-title function_">{"setCursor"}</_components.span>
            {"("}
            <_components.span className="hljs-string">{'"help"'}</_components.span>
            {");\n"}
          </_components.code>
        </_components.pre>
        {"\n"}
        <_components.h2 id="createbodycursor">
          <_components.a className="header-anchor" href="#createbodycursor">
            {"#"}
          </_components.a>
          <_components.code
            data-code-primitive-name="createBodyCursor"
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            <_components.span className="hljs-title function_">{"enabled"}</_components.span>
            {"() && "}
            <_components.span className="hljs-title function_">{"cursor"}</_components.span>
            {"());\n\n"}
            <_components.span className="hljs-title function_">{"setCursor"}</_components.span>
            {"("}
            <_components.span className="hljs-string">{'"help"'}</_components.span>
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/cursor/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
...
export default function Index() {
  return (
    <PrimitivePageMain
      packageName="@solid-primitives/cursor"
      name="cursor"
      stage={0}
      packageList={[{ name: "cursor", gzipped: "339 B", minified: "681 B" }]}
      primitiveList={[
        { name: "createBodyCursor", gzipped: "176 B", minified: "274 B" },
        { name: "createElementCursor", gzipped: "287 B", minified: "471 B" },
      ]}
    >
      <MDXContent />
    </PrimitivePageMain>
