...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/cursor" name="cursor" stage={0}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
