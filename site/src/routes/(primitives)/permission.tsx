...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/permission" name="permission" stage={3} packageList={[{"name":"permission","gzipped":"610 B","minified":"1.5 KB"}]} primitiveList={[{"name":"createPermission","gzipped":"610 B","minified":"1.5 KB"}]}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
