...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/permission" name="permission" stage={3}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
