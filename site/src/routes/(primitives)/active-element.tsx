...
function _createMdxContent(props) {
  ...
  return (
    <>
      ...
      <_components.ul>
        ...
        <_components.li>
          <_components.a href="#createActiveElement">
            <_components.code>{"createActiveElement"}</_components.code>
          </_components.a>
        ...
        <_components.li>
          <_components.a href="#createFocusSignal">
            <_components.code>{"createFocusSignal"}</_components.code>
          </_components.a>
      ...
      <_components.p>
        {"See "}
        <_components.a href="./CHANGELOG.md">{"CHANGELOG.md"}</_components.a>
      </_components.p>
    </>
  );
}
