...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/event-props" name="event-props" stage={2} packageList={[{"name":"event-props","gzipped":"268 B","minified":"435 B"}]} primitiveList={[{"name":"createEventProps","gzipped":"268 B","minified":"435 B"}]}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
