  ...
  return (
    <>
      ...
      <NoHydration>
        ...
        {"\n"}
        <_components.h3 id="createeventprops">
          <_components.a className="header-anchor" href="#createeventprops">
            {"#"}
          </_components.a>
          {"createEventProps"}
        </_components.h3>
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            {"("}
            <_components.span className="hljs-string">{"'mousedown'"}</_components.span>
            {", "}
            <_components.span className="hljs-string">{"'mousemove'"}</_components.span>
            {", "}
            <_components.span className="hljs-string">{"'mouseup'"}</_components.span>
            {");\n\n"}
            <_components.span className="hljs-keyword">{"const"}</_components.span>
            {" isMouseDown = "}
            ...
            {" (events."}
            <_components.span className="hljs-property">{"mousedown"}</_components.span>
            {"?."}
            <_components.span className="hljs-property">{"ts"}</_components.span>
            {" ?? "}
            <_components.span className="hljs-number">{"0"}</_components.span>
            {") > (events."}
            <_components.span className="hljs-property">{"mouseup"}</_components.span>
            {"?."}
            <_components.span className="hljs-property">{"ts"}</_components.span>
            {" ?? "}
            ...
            {" ("}
            <_components.span className="hljs-title function_">{"isMouseDown"}</_components.span>
            {"()) {\n    "}
            ...
            {"(events."}
            <_components.span className="hljs-property">{"mousemove"}</_components.span>
            {"?."}
            <_components.span className="hljs-property">{"clientX"}</_components.span>
            {", events."}
            <_components.span className="hljs-property">{"mousemove"}</_components.span>
            {"?."}
            <_components.span className="hljs-property">{"clientY"}</_components.span>
            {");\n  }\n})\n\n<div {...eventProps}>"}
            <_components.span className="hljs-title class_">{"Click"}</_components.span>
            {" and drag on me</div>\n"}
          </_components.code>
        </_components.pre>
        {"\n"}
        ...
        {"\n"}
        <_components.p>
          <_components.a href="https://solidjs-community.github.io/solid-primitives/event-props/">
            {"Live Site"}
          </_components.a>
        </_components.p>
        {"\n"}
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/event-props/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
...
export default function Index() {
  return (
    <PrimitivePageMain
      packageName="@solid-primitives/event-props"
      name="event-props"
      stage={2}
      packageList={[{ name: "event-props", gzipped: "173 B", minified: "212 B" }]}
      primitiveList={[{ name: "createEventProps", gzipped: "172 B", minified: "212 B" }]}
    >
      <MDXContent />
    </PrimitivePageMain>
  );
