...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/event-props" name="event-props" stage={2} packageList={[{"name":"event-props","gzipped":"173 B","minified":"212 B"}]} primitiveList={[{"name":"createEventProps","gzipped":"172 B","minified":"212 B"}]}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
