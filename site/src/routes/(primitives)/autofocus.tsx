...
function _createMdxContent(props) {
  ...
  return (
    <>
      <NoHydration>
        <_components.p>{"Primitives for autofocusing HTML elements."}</_components.p>
        {"\n"}
        <_components.p>
          {
        ...
        <_components.ul>
          ...
          <_components.li>
            <_components.code
              data-code-primitive-name="autofocus"
              data-code-package-name="autofocus"
            >
              {"autofocus"}
            </_components.code>
            {" - Directive to autofocus an element on render."}
          </_components.li>
          {"\n"}
          <_components.li>
            <_components.code
              data-code-primitive-name="createAutofocus"
              data-code-package-name="autofocus"
            >
              {"createAutofocus"}
            </_components.code>
            {" - Reactive primitive to autofocus an element on render."}
          </_components.li>
          {"\n"}
        </_components.ul>
        {"\n"}
      ...
      <CopyPackages packageName="@solid-primitives/autofocus" />
      <NoHydration>
        {"\n"}
        ...
        {"\n"}
        <_components.h3 id="useautofocus">
          <_components.a className="header-anchor" href="#useautofocus">
            {"#"}
          </_components.a>
          {"use:autofocus"}
        </_components.h3>
          ...
          <_components.code className="hljs language-tsx">
            ...
            <_components.span className="xml">
              <_components.span className="hljs-tag">
                ...
                <_components.span className="hljs-attr">{"use:autofocus"}</_components.span>{" "}
                <_components.span className="hljs-attr">{"autofocus"}</_components.span>
                {">"}
              </_components.span>
              {"\n  Autofocused\n"}
              <_components.span className="hljs-tag">
            ...
            <_components.span className="xml">
              <_components.span className="hljs-tag">
                ...
                <_components.span className="hljs-attr">{"use:autofocus"}</_components.span>
                {"="}
                <_components.span className="hljs-string">{"{false}"}</_components.span>{" "}
                <_components.span className="hljs-attr">{"autofocus"}</_components.span>
                {">"}
              </_components.span>
              {"\n  Not Autofocused\n"}
        ...
        <_components.p>
          {"The "}
          <_components.code data-code-primitive-name="autofocus" data-code-package-name="autofocus">
            {"autofocus"}
          </_components.code>
          {" directive uses the native "}
          <_components.code data-code-primitive-name="autofocus" data-code-package-name="autofocus">
            {"autofocus"}
          </_components.code>
          {
            " attribute to determine it should focus the element or not.\nUsing this directive without "
          }
          <_components.code>{"autofocus={true}"}</_components.code>
          {" (or the shorthand "}
          <_components.code data-code-primitive-name="autofocus" data-code-package-name="autofocus">
            {"autofocus"}
          </_components.code>
        ...
        {"\n"}
        <_components.h3 id="createautofocus">
          <_components.a className="header-anchor" href="#createautofocus">
            {"#"}
          </_components.a>
          {"createAutofocus"}
        </_components.h3>
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/autofocus/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
  ...
  return (
    <PrimitivePageMain
      ...
      primitiveList={[
        ...
        { name: "autofocus", gzipped: "126 B", minified: "163 B" },
      ]}
    >
      <MDXContent />
    </PrimitivePageMain>
