...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/autofocus" name="autofocus" stage={0}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
