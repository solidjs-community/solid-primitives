...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/fullscreen" name="fullscreen" stage={3}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
