...
function _createMdxContent(props) {
  ...
  return (
    <>
      ...
      <CopyPackages packageName="@solid-primitives/fullscreen" />
      <NoHydration>
        {"\n"}
        ...
        {"\n"}
        <_components.h3 id="createfullscreen">
          <_components.a className="header-anchor" href="#createfullscreen">
            {"#"}
          </_components.a>
          {"createFullScreen"}
        </_components.h3>
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            <_components.span className="hljs-title class_">{"MyComponent2"}</_components.span>
            {": "}
            ...
            {";\n  "}
            <_components.span className="hljs-keyword">{"const"}</_components.span>{" "}
            <_components.span className="hljs-attr">{"active"}</_components.span>
            {": "}
        ...
        {"\n"}
        <_components.h3 id="directive">
          <_components.a className="header-anchor" href="#directive">
            {"#"}
          </_components.a>
          {"Directive"}
        </_components.h3>
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            <_components.span className="hljs-keyword">{"const"}</_components.span>{" "}
            <_components.span className="hljs-attr">{"isActive"}</_components.span>
            {": "}
            <_components.span className="hljs-title class_">{"Accessor"}</_components.span>
            {"<"}
            <_components.span className="hljs-built_in">{"boolean"}</_components.span>
            ...
            <_components.span className="hljs-title class_">{"Accessor"}</_components.span>
            {"<"}
            <_components.span className="hljs-title class_">{"FullscreenOptions"}</_components.span>
            {" | "}
            <_components.span className="hljs-built_in">{"boolean"}</_components.span>
            {">,\n  options?: "}
            <_components.span className="hljs-title class_">{"FullscreenOptions"}</_components.span>
            ...
            {"\n\n"}
            <_components.span className="hljs-keyword">{"const"}</_components.span>{" "}
            <_components.span className="hljs-title class_">{"MyComponent"}</_components.span>
            {": "}
            <_components.span className="hljs-title class_">{"Component"}</_components.span>
            {" = "}
            <_components.span className="hljs-function">{"() =>"}</_components.span>
            ...
            <_components.span className="xml">
              <_components.span className="hljs-tag">
                {"<"}
                <_components.span className="hljs-name">{"div"}</_components.span>{" "}
                <_components.span className="hljs-attr">{"use:createFullScreen"}</_components.span>
                {"="}
                <_components.span className="hljs-string">{"{fs}"}</_components.span>{" "}
                <_components.span className="hljs-attr">{"onClick"}</_components.span>
                {"="}
                <_components.span className="hljs-string">{"{()"}</_components.span>
                {" =>"}
        ...
        {"\n"}
        <_components.p>
          <_components.a href="https://solidjs-community.github.io/solid-primitives/fullscreen/">
            {"Live Site"}
          </_components.a>
        </_components.p>
        {"\n"}
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/fullscreen/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
...
export default function Index() {
  return (
    <PrimitivePageMain
      packageName="@solid-primitives/fullscreen"
      name="fullscreen"
      stage={3}
      packageList={[{ name: "fullscreen", gzipped: "317 B", minified: "562 B" }]}
      primitiveList={[{ name: "createFullscreen", gzipped: "317 B", minified: "562 B" }]}
    >
      <MDXContent />
    </PrimitivePageMain>
  );
