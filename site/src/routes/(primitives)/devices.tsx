...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/devices" name="devices" stage={3}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
