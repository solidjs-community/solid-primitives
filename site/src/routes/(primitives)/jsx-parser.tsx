...
export default function Index() {
  return (
    ...
    >
      <MDXContent />
    <PrimitivePageMain packageName="@solid-primitives/jsx-parser" name="jsx-parser" stage={0} packageList={[{"name":"jsx-parser","gzipped":"448 B","minified":"809 B"}]} primitiveList={[{"name":"createToken","gzipped":"211 B","minified":"275 B"},{"name":"resolveTokens","gzipped":"295 B","minified":"431 B"},{"name":"isToken","gzipped":"109 B","minified":"128 B"},{"name":"createJSXParser","gzipped":"133 B","minified":"155 B"}]}>
      <MDXContent/>
    </PrimitivePageMain>
  );
}
