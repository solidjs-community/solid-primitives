    ...
    <>
      <NoHydration>
        <_components.ul>
          {"\n"}
          <_components.li>
            <_components.a href="#createPageVisibility">
              <_components.code
                data-code-primitive-name="createPageVisibility"
                data-code-package-name="page-visibility"
              >
          ...
          {"\n"}
          <_components.li>
            <_components.a href="#usePageVisibility">
              <_components.code>{"usePageVisibility"}</_components.code>
            </_components.a>
            {" - A "}
      ...
      <CopyPackages packageName="@solid-primitives/page-visibility" />
      <NoHydration>
        {"\n"}
        <_components.h2 id="createpagevisibility">
          <_components.a className="header-anchor" href="#createpagevisibility">
            {"#"}
          </_components.a>
          <_components.code
            data-code-primitive-name="createPageVisibility"
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            {" {\n  "}
            <_components.span className="hljs-title function_">{"visible"}</_components.span>
            {"(); "}
        ...
        {"\n"}
        <_components.h2 id="usepagevisibility">
          <_components.a className="header-anchor" href="#usepagevisibility">
            {"#"}
          </_components.a>
          <_components.code>{"usePageVisibility"}</_components.code>
        </_components.h2>
        ...
        <_components.p>
          ...
          {" primitive. It is providing the same signal as "}
          <_components.code
            data-code-primitive-name="createPageVisibility"
            data-code-package-name="page-visibility"
          >
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/page-visibility/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
...
export default function Index() {
  return (
    <PrimitivePageMain
      packageName="@solid-primitives/page-visibility"
      name="page-visibility"
      stage={3}
      packageList={[{ name: "page-visibility", gzipped: "535 B", minified: "1.03 KB" }]}
      primitiveList={[{ name: "createPageVisibility", gzipped: "529 B", minified: "1.01 KB" }]}
    >
      <MDXContent />
    </PrimitivePageMain>
  );
