...
function _createMdxContent(props) {
  ...
  return (
    <>
      <NoHydration>
        <_components.p>{"Creates an efficient tweening function."}</_components.p>
        {"\n"}
      ...
      <CopyPackages packageName="@solid-primitives/tween" />
      <NoHydration>
        {"\n"}
        ...
        <_components.pre>
          <_components.code className="hljs language-ts">
            ...
            {" tweenedValue = "}
            <_components.span className="hljs-title function_">{"createTween"}</_components.span>
            {"(myNumber, { "}
        ...
        <_components.p>
          {"See "}
          <_components.a href="https://github.com/solidjs-community/solid-primitives/blob/main/packages/tween/CHANGELOG.md">
            {"CHANGELOG.md"}
          </_components.a>
        </_components.p>
      </NoHydration>
...
export default function Index() {
  return (
    <PrimitivePageMain
      packageName="@solid-primitives/tween"
      name="tween"
      stage={3}
      packageList={[{ name: "tween", gzipped: "285 B", minified: "444 B" }]}
      primitiveList={[{ name: "createTween", gzipped: "279 B", minified: "431 B" }]}
    >
      <MDXContent />
    </PrimitivePageMain>
  );
