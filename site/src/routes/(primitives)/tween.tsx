...
export default function Index () {
  return (
    <PrimitivePageMain packageName="@solid-primitives/tween" name="tween" stage={3} packageList={[{"name":"tween","gzipped":"285 B","minified":"444 B"}]} primitiveList={[{"name":"createTween","gzipped":"279 B","minified":"431 B"}]}>
      <MDXContent/>
    </PrimitivePageMain>
  )
}
