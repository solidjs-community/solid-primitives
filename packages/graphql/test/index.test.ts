...
describe("makeMultipartBody", () => {
    test("top-level and nested blobs are correctly replaced", () => {
        ...
        expect(form.get("operations")).toEqual('{"query":"","variables":{"file":null,"description":"An empty file","nested":{"file":null}}}');
    ...
    test("blobs arrays are correctly replaced", () => {
        ...
        expect(form.get("operations")).toEqual('{"query":"","variables":{"files":[null,null],"description":"An array of empty files"}}');
