...
import { type Component, createRoot, createSignal, Show, createEffect } from "solid-js";
...
const TestComponent: Component = () => {
  return <div class="bg-orange-200 p-4 text-gray-800 select-none">in component: {memo()}</div>;
};
