...
describe("createProp(s)", () => {
  test('will output a boolean prop signal and a field', () => createRoot(dispose => {
  ...
  test('will output a number prop signal and a field', () => createRoot(dispose => {
  ...
  test('will output a string prop signal and a field', () => createRoot(dispose => {
  ...
  test('will output a select prop signal and a field from array', () => createRoot(dispose => {
    const languages = ['de', 'en', 'it', 'pl'];
    const [value, setValue, field] = createProp('value', { initialValue: 'en', options: languages });
  ...
  test('will output a select prop signal and a field from enum', () => createRoot(dispose => {
    enum Test {
      Zero,
      One,
      Two,
    ...
    const [value, setValue, field] = createProp('enum', { initialValue: Test.Two, options: Test });
  ...
  test('will create multiple props with createProps', () => createRoot(dispose => {
    ...
    expect(booleanInput).toBeInstanceOf(HTMLInputElement);
    expect(numberInput).toBeInstanceOf(HTMLInputElement);
    expect(stringInput).toBeInstanceOf(HTMLInputElement);
    expect(arraySelect).toBeInstanceOf(HTMLSelectElement);
    expect(enumSelect).toBeInstanceOf(HTMLSelectElement);
