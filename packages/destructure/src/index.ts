 ...
 * - `memo` - if "normalize": turn all static values to accessors (e.g. `{ a: 1 } => { a: () => 1 }` but keep all functions and accessors as they are. Allowing for React like destructuring.
