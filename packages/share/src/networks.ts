...
export const BUFFER: Network = "https://buffer.com/add?text=@t&url=@u";
...
export const INSTAPAPER: Network =
  "https://www.instapaper.com/edit?url=@u&title=@t&description=@d";
export const LINE: Network = "https://line.me/R/msg/text/?@t%0D%0A@u%0D%0A@d";
...
/** @deprecated StumbleUpon shut down in 2018 - this will be removed in a future version */
...
export const WARPCAST: Network = "https://warpcast.com/~/compose?text=@t%0D%0A@u";
export const WEIBO: Network = "https://service.weibo.com/share/share.php?url=@u&title=@t&pic=@m";
