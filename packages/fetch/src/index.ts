...
type FetchOptions<I> = I extends undefined
  ? { initialValue?: I, name?: string, fetch?: typeof fetch, responseHandler?: (response: Response) => any }
  : { initialValue: I, name?: string, fetch?: typeof fetch, responseHandler?: (response: Response) => any };
...
const isOptions = <I>(
  prop: Accessor<RequestInfo> | Accessor<RequestInit> | RequestInfo | RequestInit | FetchOptions<I> | undefined
 ...
 * ```
 */
export function createFetch<T, I = undefined>(requestInfo: Accessor<RequestInfo> | RequestInfo): FetchReturn<T, I>;
...
export function createFetch<T, I>(requestInfo: Accessor<RequestInfo> | RequestInfo, options: FetchOptions<I>): FetchReturn<T, I>;
...
export function createFetch<T, I>(
  ...
  resourceReturn = (createResource<T | I, [RequestInfo, RequestInit | undefined]>(createMemo<[RequestInfo, RequestInit | undefined]>(() => [
